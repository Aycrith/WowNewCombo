...
public sealed class Program
{
    public static void Main(string[] args)
    {
        ...
        HeadlessRouteControlHost? routeControlHost = null;
        ...
        try
        {
            ...
            HeadlessRouteControlOptions routeControlOptions =
                configuration.GetSection(HeadlessRouteControlOptions.SectionName).Get<HeadlessRouteControlOptions>() ??
            ...
            {
                routeControlHost = new HeadlessRouteControlHost(
                    provider.GetRequiredService<ILogger<HeadlessRouteControlHost>>(),
                    provider.GetRequiredService<IBotRouteControlService>(),
                    routeControlOptions);
                routeControlHost.StartAsync().GetAwaiter().GetResult();
        ...
        {
            if (routeControlHost != null)
            {
                routeControlHost.DisposeAsync().AsTask().GetAwaiter().GetResult();
            }
        }
    }

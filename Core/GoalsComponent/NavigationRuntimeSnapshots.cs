...
public sealed record NavigationRuntimeSnapshot(
    ...
    int RouteTrackerRebuildCount,
    int RouteTrackerWaypointTransitions,
    int RouteTrackerSubSegmentTransitions,
    int RouteTrackerRegressionCount,
    string? RouteTrackerLastRegressionReason,
    DateTime? RouteTrackerLastRegressionUtc,
